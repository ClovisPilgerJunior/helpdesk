...
public class DBService {
  ...
  public void startDB(){
    ...
    Technical tec1 = new Technical(null, "Junior Pilger", "61394022042", "a@a.com.br", encoder.encode("123"));
    tec1.addProfiles(Profile.ADMIN);

    // Criar técnicos
    Technical tec2 = new Technical(null,"John Doe", "03783764386", "john.doe@example.com", encoder.encode("123"));
    Technical tec3 = new Technical(null,"Mary Johnson", "11228847614", "mary.johnson@example.com", encoder.encode("123"));
    Technical tec4 = new Technical(null,"Robert Smith", "85752968097", "robert.smith@example.com", encoder.encode("123"));
    Technical tec5 = new Technical(null,"Jane Doe", "84445767867", "jane.doe@example.com", encoder.encode("123"));
    Technical tec6 = new Technical(null,"Michael Johnson", "62218888327", "michael.johnson@example.com", encoder.encode("123"));
    Technical tec7 = new Technical(null,"Emily Smith", "92241975583", "emily.smith@example.com", encoder.encode("123"));
    ...
    // Criar clientes
    Customer cus1 = new Customer(null,"Linus Torvalds", "14178441590", "linux@linux.com.br", encoder.encode("123"));
    Customer cus2 = new Customer(null,"Alice Johnson", "36562882168", "alice.johnson@example.com", encoder.encode("123"));
    Customer cus3 = new Customer(null,"David Smith", "38322565399", "david.smith@example.com", encoder.encode("123"));
    Customer cus4 = new Customer(null,"Sarah Doe", "61317166337", "sarah.doe@example.com", encoder.encode("123"));
    Customer cus5 = new Customer(null,"Robert Johnson", "21466730790", "robert.johnson@example.com", encoder.encode("123"));
    Customer cus6 = new Customer(null,"Emily Davis", "82987592736", "emily.davis@example.com", encoder.encode("123"));
